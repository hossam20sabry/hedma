...
<div class="py-3 background">
    <div class="container">
        <div class="d-flex">
            <a href="{{ route('admin.categories.index') }}" class="decoration_none"><h3 class="m_r">Categories</h3></a>
        </div>
    </div>
</div>
    ...
    <div class="row">
        ...
        <div class="col-md-6 box_shadow p-3 my-1">
            <form action="{{ route('admin.categories.store') }}" method="post">
                ...
                <div class="row">
                    <div class="col">
                        <input type="text" name="name" class="form-control" placeholder="Category name" aria-label="First name">
                    </div>
                    <div class="col">
